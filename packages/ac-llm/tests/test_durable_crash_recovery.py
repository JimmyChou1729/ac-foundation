...
from ac_jobs import RunContext, RunRepository, decode_artifact_ref
from ac_llm import (
    FailureCategory,
    HostAuthority,
    JsonOutput,
...
from ac_llm.host import HostResponse, HostResponseStatus
...
def test_second_crash_pauses_then_explicit_resume_gets_fresh_allowance(
    ...
    assert provider_failure["ac_error_code"] == "provider_timeout"
    ...
    assert diagnostic["schema_version"] == "ac.llm.provider_failure.v2"
