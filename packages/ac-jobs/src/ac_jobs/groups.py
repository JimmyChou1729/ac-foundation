...
def _unit_result(
    ...
    *,
    ...
    if document["schema_version"] != "ac.jobs.group_unit.v2":
...
def inspect_group(directory: Path, group_id: str) -> GroupView:
    ...
    if document["schema_version"] != "ac.jobs.group.v2":
        raise UnsupportedSchemaError(str(document["schema_version"]))
    ...
    def run(
        ...
        *,
        ...
        state: dict[str, JsonValue] = {
            "schema_version": "ac.jobs.group.v2",
            "group_id": group_id,
            "units": [
        ...
        if state_path.exists():
            ...
            if existing_state.get("schema_version") != "ac.jobs.group.v2":
        ...
        def invoke(unit: WorkUnit) -> UnitResult | Paused:
            ...
            document: dict[str, JsonValue] = {
                "schema_version": "ac.jobs.group_unit.v2",
